...
// import type { CreateWithBlock } from 'blockly/core';
...
type CreateWithBlock = typeof libraryBlocks.lists.CreateWithBlock;
...
export function lists_setIndex(block: Block, generator: JavaGenerator) {
