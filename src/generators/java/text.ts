...
export function text_append(block: Block, generator: JavaGenerator) {
...
export function text_print(block: Block, generator: JavaGenerator) {
    // Print statement.
